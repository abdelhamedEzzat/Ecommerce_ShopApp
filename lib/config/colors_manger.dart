...
class ColorMangers {
  static const primaryColor = Color(0xff022238);
  static const buttonColor = Color(0xff843667);
  static const semiGray = Color(0xff8D969F);
  ...
  static const semiPink = 0xffFBF3E8;
